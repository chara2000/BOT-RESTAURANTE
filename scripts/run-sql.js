...
BEGIN
    ...
    IF public.auth_tenant_id() != p_tenant_id 
       AND COALESCE((SELECT tenant_id FROM public.profiles WHERE id = auth.uid()), '00000000-0000-0000-0000-000000000000'::uuid) != p_tenant_id
...
async function run() {
  console.log('Executing DDL query via execute_sql RPC...');
