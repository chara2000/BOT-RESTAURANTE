-- RPC para calcular estadísticas de ventas y métricas para el Dashboard
...
BEGIN
    -- Verificar permisos: el usuario debe pertenecer al tenant consultado
    IF public.auth_tenant_id() != p_tenant_id THEN
